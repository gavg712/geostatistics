...
#Ejemplo de cálculo de probabilidades específicas. Este ejemplo indica la probabilidad de tener una "buena calidad de vida", si el "estado de salud" es "regular" (valor 3) y si "distancia al servicio de salud más cercano" es 150 metros. Se pueden ir variando los valores de EstaSalud y DistSalud para encontrar distintas probabilidades de "buena calidad de vida"
